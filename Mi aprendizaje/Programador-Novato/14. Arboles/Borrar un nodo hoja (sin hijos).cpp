...
void eliminarNodo(Nodo *&arbol)
{
    if (arbol->izq && arbol->der) //TODO: si hay subn arbol izq y der
    {
        Nodo *minimo = minimoNodo(arbol->der);
        arbol->dato = minimo->dato;
        eliminarNodo(minimo);
    }
    else if (arbol->izq) //TODO: si hay arbol izq
    {
        reemplazarNodo(arbol,arbol->izq);
    }
    else if (arbol->der) //TODO: si hay arbol der
    {
        reemplazarNodo(arbol,arbol->der);
    }
    else //TODO: si no hay sub arbol
    {
...
void reemplazarNodo(Nodo *&arbol,Nodo *nuevo)
{
    if (arbol->padre) //TODO: si el numero o arbol tiene padre
    {
